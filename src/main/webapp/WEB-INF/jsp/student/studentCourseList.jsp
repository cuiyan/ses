...
<br>
<div style="height: 80%">
	<table class="easyui-datagrid"  id="queryStudentCourseList" >
</table>
</div>
<script>
...
$(document).ready(function(){
	tab=$("#queryStudentCourseList").datagrid({
		url:"${pageContext.request.contextPath}/student/queryStudentCourseList",//加载的URL
...
// 	              {field:'teaNo',title:'教师编号',width:100},
	              ...
	              {field:'checkCourse',title:'选课',width:30,formatter:function(value,row,index){
	            	  return "<input type='button' class='easyui-linkbutton queryBtn' onclick='checkCourse("+row.courseNo+");' value='选课'>";
	              }}
...
function checkCourse(courseNo){
	console.log(courseNo);
	$.ajax({
		type:"post",
// 		async:false,
		url:"${pageContext.request.contextPath}/student/checkCourse",
